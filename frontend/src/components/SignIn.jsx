  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        "https://mocktest-backend-ho52.onrender.com/api/v1/auth/register",
        formData
      );
          ...
          <div className="relative">
            ...
            >
              <path
                ...
                strokeWidth={2}
                d="M5.121 17.804A8 8 0 1017.804 5.12m-5.656 11.172A4 4 0 1116.95 7.05"
              />
            </svg>
          </div>
          <div className="relative">
            ...
            >
              <path
                ...
                strokeLinejoin="round"
                strokeWidth={2}
                d="M16 12v4m-8-4v4m4-4v4m0 0h4m-4 0H8"
              />
            </svg>
          </div>
          <div className="relative">
